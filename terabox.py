...
api_id = os.environ.get('TELEGRAM_API', '27696177')
if len(api_id) == 0:
    logging.error("TELEGRAM_API variable is missing! Exiting now")
    exit(1)

api_hash = os.environ.get('TELEGRAM_HASH', '0c44906a4feff3b947db76dfa7c57d88')
if len(api_hash) == 0:
    logging.error("TELEGRAM_HASH variable is missing! Exiting now")
    exit(1)
    
bot_token = os.environ.get('BOT_TOKEN', '7153408677:AAHXfNKhAZ23GNiwdqRY5YIC9AW4XvpBYfE')
if len(bot_token) == 0:
    logging.error("BOT_TOKEN variable is missing! Exiting now")
    exit(1)
dump_id = os.environ.get('DUMP_CHAT_ID', '-1002248276059')
if len(dump_id) == 0:
...
fsub_id = os.environ.get('FSUB_ID', '-1001937292511')
if len(fsub_id) == 0:
...
async def start_command(client, message):
    ...
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/TMR_update_channel")
